...
public class SyncAccountFlow extends FlowLogic<String> {
    ...
    public String call() throws FlowException {
        ...
        try {
            List<StateAndRef<CustomTicket>> tokenStateAndRefList = getServiceHub()
                    .getVaultService()
                    .queryBy(CustomTicket.class,queryCriteria).getStates();
            for(StateAndRef<CustomTicket> tokenStateStateAndRef: tokenStateAndRefList){
